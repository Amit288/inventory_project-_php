...
//Manage Invoice Report Without Date

if(isset($_POST["manageReport"])){

	$m = new Manage();
	$output = ''; 
	$result = $m->showInvoice("invoice","invoice_details",$_POST["from_date"],$_POST["to_date"]);
	$output .= '  
...
if(isset($_POST["from_date"], $_POST["to_date"])){
	...
	$m = new Manage();
	$output = ''; 
	$result = $m->joinInvoice("invoice","invoice_details",$_POST["from_date"],$_POST["to_date"]);
	$output .= '  
           <table class="table table-bordered">  
                <thead>
                    <tr>
